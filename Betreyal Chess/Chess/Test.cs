...
namespace Chess
{
    ...
    class Test
    {
        ...
        public static void TestMoveCheckBishop()
        {
            ...
            board[3, 5] = new Queen(Color.white);
            ...
            //Tile amended
            whiteTurn = false;
            board[4, 3] = new Bishop(Color.black);
            //Just to make sure the King doesn't screw the Check check
            board[0, 1] = new King(Color.black);
        ...
        public static void TestMoveCheckKing(bool testCastlingRules)
        {
            ...
            {
                whiteTurn = true;
                board[2, 5] = new King(Color.white);
            ...
            if (testCastlingRules)
            {
                ...
                board[7, 6] = new Bishop(Color.white);
                ExecuteMoveCheckTest(board, CreateTile(7, 4), CreateTile(7, 6), false);
                ExecuteMoveCheckTest(board, CreateTile(7, 4), CreateTile(7, 2), true);
                //Tile amended
                board[7, 1] = new Bishop(Color.white);
                ExecuteMoveCheckTest(board, CreateTile(7, 4), CreateTile(7, 2), false);
                //Condition change
                whiteTurn = true;
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), true);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 6), true);
                //Tile amended
                board[2, 2] = new Bishop(Color.black);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), false);
                //Tile amended
                //Rook can be in Check
                board[2, 2] = new EmptyTile();
                board[2, 3] = new Bishop(Color.black);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), true);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 6), false);
                //Tile amended
                board[3, 6] = new Bishop(Color.black);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), false);
                //Tile amended
                board[2, 5] = new Rook(Color.black);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), true);
                //Tile amended
                board[2, 4] = new Bishop(Color.black);
                ExecuteMoveCheckTest(board, CreateTile(0, 4), CreateTile(0, 2), false);
        ...
        public static void TestMoveCheckKnight()
        {
            ...
            board[1, 1] = new Queen(Color.black);
            board[1, 3] = new Queen(Color.black);
            board[1, 5] = new Queen(Color.black);
            board[2, 2] = new Queen(Color.white);
            board[2, 3] = new Queen(Color.white);
            board[2, 4] = new Queen(Color.black);
            board[3, 1] = new Queen(Color.white);
            //Just to make sure the King doesn't screw the Check check
        ...
        public static void TestMoveCheckPawn()
        {
            ...
            //Tile amended
            board[5, 4] = new Queen(Color.white);
            ...
            //Tile amended
            board[2, 0] = new Pawn(Color.white);
            ...
            board[5, 4] = new Knight(Color.black);
            ...
            //Tile amended
            board[5, 3] = new Knight(Color.white);
            board[3, 1] = new Knight(Color.black);
            ...
            //Tile amended
            board[4, 1] = new Knight(Color.black);
            ...
            board[3, 2] = new Pawn(Color.black);
            whiteTurn = false;
            ExecuteMoveCheckTest(board, CreateTile(3, 2), CreateTile(2, 1), false);
            //Condition change
            board[3, 1] = new Pawn(Color.white) { EnPassant = true };
        ...
        public static void TestMoveCheckQueen()
        {
            ...
            whiteTurn = false;
            //Just to make sure the King doesn't screw the Check check
            board[2, 0] = new King(Color.black);
            board[4, 3] = new Queen(Color.black);
            ExecuteMoveCheckTest(board, CreateTile(4, 3), CreateTile(6, 5), true);
            ExecuteMoveCheckTest(board, CreateTile(4, 3), CreateTile(1, 0), true);
            ExecuteMoveCheckTest(board, CreateTile(4, 3), CreateTile(1, 6), true);
            ExecuteMoveCheckTest(board, CreateTile(4, 3), CreateTile(5, 2), true);

            board[3, 3] = new Queen(Color.black);
            board[3, 1] = new Pawn(Color.white);
            ...
            board[6, 3] = new King(Color.black);
        ...
        {
            whiteTurn = false;
            board[3, 3] = new Rook(Color.black);
            board[3, 1] = new Pawn(Color.white);
        ...
        {
            bool whiteTurn = board[fromTile.x, fromTile.y].color == Color.white ? true : false;
        ...
        private static void ExecuteCheckMateTest(GameState desiredTestResult, List<Tile> fromTiles, List<Tile> toTiles)
        {
            ...
            GameState testResult = MoveCheck.IsGameCheckMate(board, toTiles[toTiles.Count - 1], board[toTiles[toTiles.Count-1].x, toTiles[toTiles.Count-1].y].color == Color.white);
            string success = desiredTestResult == testResult ? "Success!" : "***";
            Console.WriteLine($"Test {testCounter} expected {desiredTestResult}, is {testResult}. {success}");
        ...
        public static string[] BoardVisualisation(Piece[,] board)
        {
